<div id="body">
	<div class="content">
		<div class="section">
			...
			<div class="gallery">
				<h2>Supprimer une Maison ou un appartement</h2>
				<ul>
					...
					<li>
						...
						<p>
							<a href="<?php echo base_url("maintenance-confirmer1-".$tmp["IDMAISON"].".html") ?>" class="form1" id="send2" >supprimer</a>
						</p>
					</li>
					<?php } ?>
				</ul>
			...
			<div class="paging">
				...
				<ul>
					...
					<li <?php if($CUR == $j) echo "class=\"selected\""?>>
						<a href="<?php echo "maintenance-supprimer-".$j.".html"?>"><?php echo $j ?></a>
					</li>
					<?php } ?>
				</ul>
			</div>
